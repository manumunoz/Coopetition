...
doc = """
Encryption trial for Preferences for Cooperation or Competition
"""

class Constants(BaseConstants):
    name_in_url= 'encryption_trial'
...
class Player(BasePlayer):
    ...
    total_codes    = models.IntegerField(label='',initial=0)
    good_codes     = models.IntegerField(label='',initial=0)
    bad_codes      = models.IntegerField(label='',initial=0)
